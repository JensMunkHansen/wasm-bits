// JavaScript wrapper for vtkStructuredPointsGeometryFilter with embind 
//
...
node /home/jmh/github/VTKCMake/build/library/VTK-prefix/src/VTK-build/bin/vtkWrapJavaScript.js \
 ...
 -o \
 /home/jmh/github/VTKCMake/build/library/VTK-prefix/src/VTK-build/CMakeFiles/vtkFiltersGeometry.js/vtkStructuredPointsGeometryFilterEmbinding.cxx \
 /home/jmh/github/vtk/Filters/Geometry/vtkStructuredPointsGeometryFilter.h
*/
...
template<> void emscripten::internal::raw_destructor<vtkStructuredPointsGeometryFilter>(vtkStructuredPointsGeometryFilter * ptr){ ptr->Delete(); }
EMSCRIPTEN_BINDINGS(vtkStructuredPointsGeometryFilter_class) {
  emscripten::class_<vtkStructuredPointsGeometryFilter, emscripten::base<vtkImageDataGeometryFilter>>("vtkStructuredPointsGeometryFilter")
    ...
    .function("NewInstance", &vtkStructuredPointsGeometryFilter::NewInstance, emscripten::allow_raw_pointers())
    .class_function("GetNumberOfGenerationsFromBaseType", emscripten::optional_override([]( const std::string & arg_0) -> int {  return vtkStructuredPointsGeometryFilter::GetNumberOfGenerationsFromBaseType( arg_0.c_str());}))
    .function("GetNumberOfGenerationsFromBase", emscripten::optional_override([](vtkStructuredPointsGeometryFilter& self, const std::string & arg_0) -> int {  return self.GetNumberOfGenerationsFromBase( arg_0.c_str());}));
}
