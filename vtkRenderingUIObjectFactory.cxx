...
VTK_CREATE_CREATE_FUNCTION(vtkWebAssemblyRenderWindowInteractor)


vtkRenderingUIObjectFactory::vtkRenderingUIObjectFactory()
{
this->RegisterOverride("vtkRenderWindowInteractor", "vtkWebAssemblyRenderWindowInteractor", "Override for VTK::RenderingUI module", 1, vtkObjectFactoryCreatevtkWebAssemblyRenderWindowInteractor);
